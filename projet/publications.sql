...
liaison_id INT(8) NOT NULL AUTO_INCREMENT,
followed_id INT(8) NOT NULL,
follower_id INT(8) NOT NULL,
PRIMARY KEY (liaison_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE signaler (
signal_id INT(8) NOT NULL AUTO_INCREMENT,
signal_question_id INT(8) UNSIGNED NOT NULL,
signal_motif TEXT NOT NULL,
signal_date DATETIME NOT NULL,
signal_de INT(8) UNSIGNED NOT NULL,
