...
if ((empty($_POST['reponse']))){
    ...
    include_once('repondrequestion.php');
        ...
        $req='INSERT INTO publication (post_contenu, post_date, post_question, post_de) VALUES (\''.mysqli_real_escape_string($connexion,$_POST['reponse']).'\', now(),\''.$_GET['question_id'].'\',\''.$_SESSION['id'].'\');';
